...
export function generateTestData(): TestSeedData {
  return {
    ...
    users: [
      ...
      { id: 'user-003', teamId: 'team-delhi-001', code: 'sup001', displayName: 'Amit Kumar (Supervisor)', role: 'FIELD_SUPERVISOR', pin: '345678', isActive: true },
      ...
      { id: 'user-006', teamId: 'team-mumbai-002', code: 'sup002', displayName: 'Neha Joshi (Supervisor)', role: 'FIELD_SUPERVISOR', pin: '678901', isActive: true },
      { id: 'user-007', teamId: 'team-bangalore-003', code: 'emp005', displayName: 'Arjun Nair', role: 'TEAM_MEMBER', pin: '789012', isActive: true },
      { id: 'user-008', teamId: 'team-bangalore-003', code: 'admin001', displayName: 'Admin User', role: 'SYSTEM_ADMIN', pin: '890123', isActive: true },
